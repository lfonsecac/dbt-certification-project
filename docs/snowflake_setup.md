...
CREATE WAREHOUSE IF NOT EXISTS DBT_CERTIFICATION_PROJECT_WH;
GRANT OPERATE ON WAREHOUSE DBT_CERTIFICATION_PROJECT_WH TO ROLE TRANSFORM;
...
CREATE USER IF NOT EXISTS dbt
  ...
  DEFAULT_WAREHOUSE='DBT_CERTIFICATION_PROJECT_WH'
...
GRANT ALL ON WAREHOUSE DBT_CERTIFICATION_PROJECT_WH TO ROLE transform; 
